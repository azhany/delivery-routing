...
use App\Actions\V2\Customer\StoreCustomerAction;
...
class PhoneController extends Controller
{
    ...
    public function verify(VerifyRequest $request)
    {
        ...
        try {
            $user = (new StoreCustomerAction)->execute($request->unverifyAccount, $request->phoneVerify->phone_code, $request->phoneVerify->phone_number);

            $accessToken = $user->createToken('Snapx', ['customer'])->accessToken;
