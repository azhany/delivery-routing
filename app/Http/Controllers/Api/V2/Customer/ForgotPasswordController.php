...
use App\Http\Requests\V2\Customer\ForgotPasswordSendRequest;
...
class ForgotPasswordController extends Controller
{
    ...
    {
        (new DeletePasswordResetIfExistAction)->execute($request->customer->passwordReset);

        $passwordReset = (new StorePasswordResetAction)->execute($request->customer->passwordReset(), $request->all());
